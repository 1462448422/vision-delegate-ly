 ...
 */
export const DEFAULT_RECOGNITION_PROMPT =
  'You are an image-recognition assistant for a text-only model that cannot see images.\n'
 ...
 */
export function renderRecognitionText(model: string, description: string): string {
